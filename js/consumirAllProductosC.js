		...
		$.ajax({
			...
			success: function (data) {
				...
				for (i = 0; i < data.length; i++) { 
					code = code + '<div class="col-xs-4 col-md-3"><div class="card mb-3"><a href="#"><img class="card-img-top" src="'+data[i].url_foto+'" alt="" width="30" height="200"></a><div class="card-body"><h6 class="card-title mb-1"><a href="#">'+data[i].nombre+'</a></h6><small>Sku: '+data[i].sku+'</small><br><small>Precio: '+data[i].precio+'</small><br><small>Stock: '+data[i].stock+'</small></div><div class="card-body py-2 small" style="text-align: center"><a class="mr-3 d-inline-block" href="#"><i class="fa fa-shopping-cart"></i> Comprar</a></div></div></div>';
				}
				code = code + '</div>';
				$("#grid").html(code);
			},
